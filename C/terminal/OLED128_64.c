...
int main(int argc, char *argv[]) {
	...
	for(i=0;i<8;i++)
    for(j=0;j<128;j++){
      LCD_WrDat(i*8, j, robot[128*i+j]);
    }
    Sleep(3000);
    system("cls");
    
	LCD_P6x8Str(0, 0, "Hello,world,");
	LCD_P6x8Str(8, 0, "this is for everyone!");
	LCD_P8x16Str(16, 0, "Welcome to");
	LCD_P8x16Str(32, 0, "muyuan! ^_^");
	LCD_P8x16Str(48, 0, "bye bye");
	time_t moment=0;
	struct tm *t;
	char buffer[9]={0};
	while(1){
